package br.com.udemy.controllers.docs;
...
public interface BookControllerDocs {
    ...
    @Operation(summary = "Find a Book", description = "Find a specific book by your ID", tags = {"Books"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
    ...
    @Operation(summary = "Updates a book information",
            description = "Updates a book information by passing in a JSON representation of the updated book.",
            tags = {"Books"},
            responses = {
                    @ApiResponse(
                            description = "Success",
